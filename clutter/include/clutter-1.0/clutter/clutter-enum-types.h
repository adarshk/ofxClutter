...
GType clutter_redraw_flags_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_REDRAW_FLAGS (clutter_redraw_flags_get_type())

/* enumerations from "./clutter-align-constraint.h" */
GType clutter_align_axis_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_ALIGN_AXIS (clutter_align_axis_get_type())

/* enumerations from "./clutter-animator.h" */
GType clutter_interpolation_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INTERPOLATION (clutter_interpolation_get_type())

/* enumerations from "./clutter-bind-constraint.h" */
...
/* enumerations from "./clutter-flow-layout.h" */
...
/* enumerations from "./clutter-input-device.h" */
...
GType clutter_shader_error_get_type (void) G_GNUC_CONST;
...
/* enumerations from "./clutter-table-layout.h" */
